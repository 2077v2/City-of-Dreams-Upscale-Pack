...
*   Mods for
    ...
    **Cyberpunk 2077**
    ...
    are pretty reliable but its always good to make a backup of your saved file. Save files can be found here>
...
1.  ⛔ While still in settings go to the "
    ...
    **V2077 Settings"**
    ...
    tab and make sure that REDmod Autoconvert is disabled like in the picture below.
...
*   **GOG>**
    ...
    *Drive Letter:\Games\Cyberpunk 2077*

*   **Steam>**

    *Drive Letter:\Games\Steam\steamapps\common\Cyberpunk 2077*

*   **Epic>**

    *Drive Letter:\Epic Games\Cyberpunk 2077*

## [My game is crashing on startup?](https://) or [My game wont launch after Collection Update?](https://)

Perform a Cyberclean.
...
3.  Go to the following location and delete the
